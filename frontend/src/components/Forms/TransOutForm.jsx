            ...
            >
              ...
              <div className="flex flex-row ">
                <div className="flex-initial w-30 mr-10 ...">
                  ...
                  <input
                    className="
                    border border-slate-600 rounded text-center shadow-sm py-2 mb-5 focus:outline-none focus:border-sky-500 focus:ring-1 sm:text-sm placeholder:italic placeholder:text-slate-400" placeholder="Enter Age eg. 48"
                    type="text"
                ...
                <div className="flex ">
                  <div className="flex-initial w-30  ...">
                    ...
                    <select
                      ...
                      name="gender"
                      onChange={handleChange}
                      className="border-collapse border border-slate-600 rounded text-slate-400 text-center w-[180px]  shadow-sm py-2 focus:outline-none focus:border-sky-500 focus:ring-1 sm:text-sm"
                      required
                    >
              ...
              <div className="flex flex-row">
                ...
                <div className="flex-initial w-30  ...">
                  <label className="grid mb-2" htmlFor="Admission-Outcome">
                    Trans-Out Date
                  </label>
                  <input
